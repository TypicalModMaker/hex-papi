...
public final class HexUtils {
    ...
    public static String parseRainbow(String message) {
        ...
        while (matcher.find()) {
            ...
            parsed = getString(parsed, matcher, parsedRainbow, stop, chars, rainbow);
    ...
    public static String parseGradients(String message) {
        ...
        while (matcher.find()) {
            ...
            parsed = getString(parsed, matcher, parsedGradient, stop, chars, gradient);
    ...
    @NotNull
    private static String getString(String parsed, Matcher matcher, StringBuilder parsedGradient, int stop, char[] chars, ColorGenerator gradient) {
